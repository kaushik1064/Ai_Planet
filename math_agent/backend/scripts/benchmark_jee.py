...
class JEEBenchmark:
    ...
    async def run_benchmark(self, max_problems: Optional[int] = 50) -> Dict[str, Any]:
        """Run the JEE benchmark with first 50 problems"""
        ...
        # Always limit to first 50 problems for manageable evaluation
        problems = problems[:max_problems]
        print(f"📚 Evaluating first {len(problems)} problems from JEE dataset")
        print(f"🎯 Using sample size of {max_problems} for efficient evaluation")
    ...
    def _compare_with_other_models(self, comparison_data: Dict[str, List[Dict[str, Any]]]) -> Dict[str, Any]:
        """Compare performance with other models using first 50 problems"""
        
        comparison_results = {}
        
        for model_name, model_responses in comparison_data.items():
            # Also limit comparison data to first 50 for fair comparison
            limited_responses = model_responses[:50]
            correct_count = 0
            total_count = len(limited_responses)
...
async def main():
    ...
    try:
        # Run benchmark with first 50 problems for efficient evaluation
        print("🎯 Running JEE Benchmark with first 50 problems")
        print("💡 This provides a representative sample while keeping evaluation manageable")
        print("🚀 The LLM will handle the mathematical reasoning without needing vector conversion")
        print()
        ...
        print("📊 Results provide insights into mathematical reasoning capabilities")
        print("🔄 The system leverages LLM intelligence for problem-solving")
